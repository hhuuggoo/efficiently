...
(function() {
  ...
  Efficiently.OutlineViewState = (function(_super) {
    ...
    function OutlineViewState() {
      ...
      return OutlineViewState.__super__.constructor.apply(this, arguments);
    }
  ...
  Efficiently.KeyEventer = (function(_super) {
    ...
    function KeyEventer() {
      ...
      return KeyEventer.__super__.constructor.apply(this, arguments);
    }
    ...
    KeyEventer.prototype.toggle_outline_global = function(e) {
      var child, nextnode, _i, _len, _ref;
      ...
      _ref = this.docview.children(this.docview.model, false);
  ...
  Efficiently.DocView = (function(_super) {
    ...
    DocView.prototype.show_children = function(node) {
      var child, children, grandchild, _i, _j, _len, _len1, _ref;
      children = this.children(node, false);
      for (_i = 0, _len = children.length; _i < _len; _i++) {
        child = children[_i];
        _ref = this.children(child, false);
  ...
  Efficiently.Document = (function(_super) {
    ...
    Document.prototype.make_state_regexp_map = function() {
      var map, state, _i, _len, _ref;
      map = {};
      _ref = this.get('todostates');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        state = _ref[_i];
  ...
  Efficiently.OutlineNodes = (function(_super) {
    ...
    OutlineNodes.prototype._sync_all = function() {
      var id, model, saveurl, tosave, _ref;
      tosave = {
        'outline': {}
      };
      _ref = this.storage;
  ...
  Efficiently.BasicNodeContentView = (function(_super) {
    ...
    function BasicNodeContentView() {
      ...
      return BasicNodeContentView.__super__.constructor.apply(this, arguments);
    }
  ...
  Efficiently.format_text = function(text, document) {
    var color, html, key, regexp, _ref;
    _ref = document.state_regexp_map;
    for (key in _ref) {
      if (!__hasProp.call(_ref, key)) continue;
      regexp = _ref[key];
  ...
  Efficiently.set_text = function(text, document, data) {
    var key, newval, regexp, set, _ref;
  ...
  Efficiently.WSOutlineCache = (function() {
    ...
    WSOutlineCache.prototype.update_collection = function() {
      var id, key, node, tochange, _i, _len, _ref, _results;
